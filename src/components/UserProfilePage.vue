	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9 col-sm-12 col-xs-12">
				<div class="hero-ct">
                    <h1>{{ fullName == null ? "PLEASE COMPLETE YOUR USER INFORMATION" : fullName }}</h1>
                    <ul class="breadcumb">
		...
		<div class="row ipad-width">
			<div class="col-md-3 col-sm-12 col-xs-12">
				<div class="user-information">
					<div class="user-img">
						<a v-if="user.profileImage == null" href="#"><img :src="$USER_PHOTOS_URL + '/user-photos/user-no-name.png' " alt="No User Profile"><br></a>
                        <a v-if="user.profileImage != null" href="#"><img :src="$USER_PHOTOS_URL + user.profileImage " alt="No User Profile"><br></a>
					...
					<form @submit="handleChangePassword">
						...
						<div class="row">
							<div class="col-md-6 form-it">
								...
								<input type="text" placeholder="***************" v-model="newPassword">
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 form-it">
								<label>Confirm New Password</label>
								<input type="text" placeholder="***************" v-model="newPassword2">
							</div>
						</div>
						<div class="row">
							<div class="col-md-2">
...
export default{
    ...
    methods:{
        getUserProfileInfo(){
            ...
            userService.getUserProfile(this.userId).then(
                (response) => {
                    ...
                    this.user = new User(userData.username, userData.email, userData.password);
					...
					if (this.user.firstName != null && this.user.lastName != null){
						this.fullName = this.user.firstName + " " + this.user.lastName+"'s Profile";
					}
		...
		handleUpdateProfile(e){
			...
			const date = new Date(inputElements[4].value);
		...
		handleChangePassword(e){
			...
			if (this.newPassword == this.newPassword2){
				...
				const userService = new UserService();
				userService.changeUserPassword(this.userId, this.oldPassword, this.newPassword).then(
					(response) =>{
